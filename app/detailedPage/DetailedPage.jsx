...
export default function DetailedPage({ info }) {
  ...
  let dollarsToEuro = 1 / 1.056832; //I manually put the conversion because the API given has limited API consumption/usage
  ...
  }, [dispatch, session?.user.id, localdata.length]);
  ...
  }, [dispatch, info.title, session?.user.id, counter]);
